...
layout = [
    ...
    [sg.Text('Place Master File under Data/MERGE/Parent folder')],
    ...
    [sg.Text('Place Master File under Data/VLOOKUP/Parent folder')],
    [sg.Text('Place Child File under Data/VLOOKUP/Child folder')],
